...
if COMM_METHOD == "I2C":
  ...
  DAC = DFRobot_GP8630N_I2C(i2c_sda=17,i2c_scl=27)
else:
...
def setup():
  ...
  if COMM_METHOD == "I2C":
    ...
    '''
      ...
      @n If you want to output a -10-0V or 0-10V voltage signal or 0-20mA current signal, please multiply it by the proportion coefficient of 0.84.
      @n For example: setDACOutVoltage(data*0.84);
